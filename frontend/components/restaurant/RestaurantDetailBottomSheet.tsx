...
const TOPPINGS: Topping[] = [
    { id: 'olives', name: 'Olives', imageUrl: 'olives' },
    { id: 'cheese', name: 'Cheese', imageUrl: 'cheese' },
    { id: 'mushroom', name: 'Mushroom', imageUrl: 'mushroom' },
]
...
export const RestaurantDetailBottomSheet: React.FC<RestaurantDetailBottomSheetProps> = ({
    ...
    const [selectedTopping, setSelectedTopping] = useState<string>('olives')
    ...
    const calculateTotalPrice = () => {
        ...
        // Add topping price (assuming ₹3.52 per topping for now)
        const toppingPrice = 3.52
        ...
        >
            <View style={{ flex: 1 }}>
                ...
                >
                    ...
                    {/* Toppings Section - Dark Background */}
                    {/* <View
            className="px-6 py-6"
            style={{
          ...
          >
            ...
            {TOPPINGS.map((topping) => (
              ...
              >
                <View
                  className="w-[39.17px] h-[39.17px] rounded-full items-center justify-center mr-3"
                  style={{ backgroundColor: '#FFFFFF' }}
                >
                  <Text className="text-lg">
                    {TOPPING_ICONS[topping.id] || '🍄'}
                  </Text>
                </View>
                <Text
                  style={{
                ...
                <View
                  ...
                  style={{
                    borderColor: selectedTopping === topping.id ? '#FF6B57' : '#464955',
                    backgroundColor: selectedTopping === topping.id ? '#FF6B57' : 'transparent',
                  }}
                >
